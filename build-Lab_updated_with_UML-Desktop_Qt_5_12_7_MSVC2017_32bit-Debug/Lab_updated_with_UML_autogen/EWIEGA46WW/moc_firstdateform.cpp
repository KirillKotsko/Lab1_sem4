...
QT_MOC_LITERAL(3, 22, 13), // "TimeManagment"
QT_MOC_LITERAL(4, 36, 4), // "data"
QT_MOC_LITERAL(5, 41, 21) // "on_buttonBox_accepted"

    },
    "FirstDateForm\0accept\0\0TimeManagment\0"
    "data\0on_buttonBox_accepted"
};
...
void FirstDateForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FirstDateForm *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->accept((*reinterpret_cast< const TimeManagment(*)>(_a[1]))); break;
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< TimeManagment >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (FirstDateForm::*)(const TimeManagment & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FirstDateForm::accept)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FirstDateForm::accept(const TimeManagment & _t1)
{
